...
window.addEventListener('DOMContentLoaded', function () {
  ...
  player.init();
  var education = new _modules_difference__WEBPACK_IMPORTED_MODULE_4__["default"]('.officerold', '.officernew', '.officer__card-item');
  education.init();
...
Difference.prototype.hideItems = function (items) {
...
function () {
  function Form(forms) {
    ...
    this.message = {
      loading: 'Loading...',
      success: 'Thank you! We call you back soon',
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    key: "autoPlayActivate",
    value: function autoPlayActivate() {
      var _this2 = this;
    ...
    value: function nextSlide() {
      ...
      this.slides.forEach(function (slide) {
        if (slide.tagName === "BUTTON") {
          ...
          _this3.container.insertBefore(active, slide);
        }
      });
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        _this4.slides.forEach(function (slide) {
          if (slide.tagName === "BUTTON") {
            var _active = _this4.slides[_this4.slides.length - 3];

            _this4.container.appendChild(_active);
          }
        });

        var active = _this4.slides[_this4.slides.length - 1];
